            ...
            <div key={index} className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <Avatar className="h-8 w-8">
                  <AvatarImage src="https://imgs.search.brave.com/i9RDtXHhCT6JBeH0Wf-D9DMLf3zYKPIUek6zwS2v6Zk/rs:fit:500:0:0:0/g:ce/aHR0cHM6Ly9pbWFn/ZXMudW5zcGxhc2gu/Y29tL3Bob3RvLTE1/NTcxMjgzOTgtZTA3/NmE2YzY0ZDVmP2Zt/PWpwZyZxPTYwJnc9/MzAwMCZpeGxpYj1y/Yi00LjAuMw.jpeg"/>
                </Avatar>
